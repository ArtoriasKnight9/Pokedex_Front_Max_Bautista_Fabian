...
export class AppComponent implements OnInit {
  ...
  sortPokemons() {
    ...
    } else if (this.sortCriteria === 'level') {
      this.pokemons.sort((a, b) => b.level_pokemon - a.level_pokemon); // Del más fuerte al más débil
    }
  }
  ...
  applyFilter() {
    ...
    if (this.searchTerm && this.searchTerm.trim() !== '') {
      ...
      result = result.filter(p => p.name_pokemon.toLowerCase().includes(term));
    }
